<?php
    $userName = $_SESSION['user']['prenom'] ?? 'Utilisateur';
                            ...
                            <div class="dropdown">
                                <button class="btn btn-outline-secondary d-flex align-items-center" 
                                    ...
                                    <!-- <span class="d-none d-md-inline">John Doe</span> -->
                                     <span class="d-none d-md-inline"><?= htmlspecialchars($userName . ' ' . $userLastName) ?></span>
                    ...
                    <div x-data="messagesComponent" x-init="init()" class="messages-container">
                        <div class="messages-layout">
                            ...
                            <div class="messages-sidebar" :class="{ 'mobile-show': sidebarVisible }">
                                ...
                                <!-- ================================================================================================================ -->
                                <div class="user-picker" x-show="showUserPicker">
